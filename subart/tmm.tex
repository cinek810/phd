...
\label{eq:tmm-2l}
\end{equation}
dodając kolejne warstwy np. po lewej stronie od warstwy z~rysunku \ref{fig:tmm-simple}. Wtedy $U_i^1$ i~$U_r^1$ obliczone według wzoru \ref{eq:tmm-1l} są równene odpowiednio amplitudom $U_t^2$ i $U_b^2$ dla kolejnej warstwy we wzorze (\ref{eq:tmm-2l}). Podstawiając do wzoru \ref{eq:tmm-2l} otrzymujemy 
\begin{equation}
\begin{bmatrix}
U_i^2 \\ 
U_r^2
