...
\begin{subfigure}{0.5\textwidth}
	...
	\label{fig:d-lusok}
\end{subfigure}
\caption{Wyniki rozwiązania problemu sprzęgania falido falowodu planarnego o~grubości $h=$400~$\mu$m z~GaAs za pomocą siatki dyfrakcyjnej.  (a) Zależność $n_{\textrm{eff}}$ od długości fali, (b)~wykres łączący okres siatki dyfrakcyjnej z~długością fali dla której pracuje antena. }
\end{figure}
