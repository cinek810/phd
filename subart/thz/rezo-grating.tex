...
\begin{figure}[bth]
	...
	\end{subfigure}
	\caption{Rozkład całkowitej energii pola E-M dookoła siatki złotej oświetlonej z góry za pomocą monochromatycznego źródła o długości fali (a) $\lambda=525\mu$ m, (b) $\lambda=500\mu$m} 
\end{figure}
