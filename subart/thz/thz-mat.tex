...
%		\caption{Zależność przenikalności elektrycznej od długości fali w zakresie od~$1$~do~$300$~THz, dla }
		\label{fig:aueps}
	\end{subfigure}
	\begin{subfigure}{.45\textwidth}
		\includegraphics[width=\textwidth]{images/gaaseps.png}
%		\caption{Zależność przenikalności elektrycznej od długości fali w zakresie, od~$17$~do~$300$~THz dla  }
		\label{fig:gaaseps}
	\end{subfigure}
