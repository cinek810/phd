...
\begin{frame}
	\begin{columns}
		...
		\end{column}
	\end{columns}
	Plots for $f=\frac{d}{L}=$0.01, 0.1 and 0.5\\
...
\begin{frame}
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.5\textwidth}
				\includegraphics[width=\textwidth]{rez_trans_L.png}\\
...
%		{\tiny	Dzięki oddzielnemu rozważaniu polaryzacji możemy wykluczyć zależność od części parametrów materiałowych. Nie możemy jednak wykluczyć zespolonego charakteru µ.}
